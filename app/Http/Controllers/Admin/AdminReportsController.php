...
public function serviceSummary(Request $request)
{
    ...
    return Inertia::render('Admin/Reports/ServiceSummary', [
   ...
   public function ageDistribution(Request $request)
{
    ...
    return Inertia::render('Admin/Reports/AgeDistribution', [
    ...
    public function clientTypeDistribution(Request $request)
{
    ...
    return Inertia::render('Admin/Reports/ClientTypeDistribution', [
...
public function ccSqdSummary(Request $request)
{
 ...
 $ccInsights = [];
    ...
    return Inertia::render('Admin/Reports/CcSqdSummary', [
        'ccData'      => $ccData,
...
public function regionDistribution(Request $request)
{
    ...
    return Inertia::render('Admin/Reports/RegionDistribution', [
        'regions'  => $regions,
        'total'    => $total,
        'insights' => $insights,
    ]);
...
public function genderDistribution(Request $request)
{
    ...
    return Inertia::render('Admin/Reports/GenderDistribution', [
        'genders'  => $genders,
        'total'    => $total,
        'insights' => $insights,
    ]);
